...
@TeleOp (name = "Tanvi is a Arcade Tank")
public class Arcade extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (dSpeed) {
                drivetrain.ArcadeDrive(gamepad1.left_stick_y, gamepad1.right_stick_x, gamepad1.left_stick_x);
                telemetry.addData("Drivetrain","Fast");
            }
            else{
                drivetrain.ArcadeDriveSlow(gamepad1.left_stick_y, gamepad1.right_stick_x, gamepad1.left_stick_x);
