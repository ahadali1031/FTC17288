...
@Autonomous(name = "Safe + Wobble")

public class BasicPlusWobble extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(250);
        drivetrain.StraightStrafeLeft(14,0.45);
        sleep(250);
        drivetrain.turnWithGyro(0);
        sleep(250);
        drivetrain.driveStraight(2,0.3);
        sleep(1000);
        drivetrain.turnWithGyro(75);
        sleep(250);
        ...
        sleep(500);
        drivetrain.driveStraight(5,0.45);
        sleep(250);
        drivetrain.turnWithGyro(30);
        sleep(500);
        drivetrain.turnWithGyro(0);
        sleep(500);
